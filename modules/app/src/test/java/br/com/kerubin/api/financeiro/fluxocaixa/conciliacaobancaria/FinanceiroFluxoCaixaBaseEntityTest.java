...
@TestPropertySource(locations = "classpath:conciliacao-bancaria.properties")
@DataJpaTest
@EnableJpaAuditing(auditorAwareRef="auditorAware")
public class FinanceiroFluxoCaixaBaseEntityTest {
	...
	@TestConfiguration
	static class FinanceiroFluxoCaixaBaseEntityTestConfig {

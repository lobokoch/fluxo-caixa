...
public class CaixaLancamentoServiceTest extends FinanceiroFluxoCaixaBaseEntityTest {
	...
	public void testCreateWithAllFields() throws Exception {
		...
		caixaLancamento.setValorCredito(new java.math.BigDecimal("19685.32621"));
		caixaLancamento.setValorDebito(new java.math.BigDecimal("32494.23233"));
	...
	public void testUpdateWithAllFields() throws Exception {
		...
		caixaLancamento.setDataLancamento(getNextDate());
		caixaLancamento.setTipoLancamentoFinanceiro(TipoLancamentoFinanceiro.DEBITO);
		caixaLancamento.setValorCredito(new java.math.BigDecimal("10665.6479"));
		caixaLancamento.setValorDebito(new java.math.BigDecimal("15266.13626"));
		caixaLancamento.setFormaPagamento(FormaPagamento.DINHEIRO);
	...
	protected CaixaLancamentoEntity newCaixaLancamentoEntity() {
		...
		caixaLancamentoEntity.setValorCredito(new java.math.BigDecimal("14574.1190"));
		caixaLancamentoEntity.setValorDebito(new java.math.BigDecimal("10056.18602"));
	...
	protected CaixaDiarioEntity newCaixaDiarioEntity() {
		...
		caixaDiarioEntity.setSaldoInicial(new java.math.BigDecimal("4505.20023"));
		caixaDiarioEntity.setDataHoraFechamento(java.time.LocalDateTime.now());
		caixaDiarioEntity.setSaldoFinal(new java.math.BigDecimal("695.23982"));
	...
	protected CaixaEntity newCaixaEntity() {
		...
		caixaEntity.setSaldo(new java.math.BigDecimal("10009.19027"));
	...
	protected CartaoCreditoEntity newCartaoCreditoEntity() {
		...
		cartaoCreditoEntity.setValorLimite(new java.math.BigDecimal("24545.21392"));

...
@RestController
@RequestMapping("financeiro/fluxo_caixa/entities/cliente")
public class ClienteController {
	...
	@GetMapping("/clienteNomeAutoComplete")
	public Collection<ClienteNomeAutoComplete> clienteNomeAutoComplete(@RequestParam("query") String query) {
